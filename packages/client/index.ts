...
function printCliHelp(): void {
  ...
  console.log('  # Connect to CodeMesh stdio server and list tools')
  console.log('  npx tsx packages/client/index.ts --stdio tsx packages/codemesh-server/src/index.ts --list-tools')
  console.log('')
  console.log('  # Call discover-tools on CodeMesh')
  console.log('  npx tsx packages/client/index.ts --stdio tsx packages/codemesh-server/src/index.ts --call-tool discover-tools')
  console.log('')
  console.log('  # Connect to HTTP server and list tools')
  console.log('  npx tsx packages/client/index.ts --connect http://localhost:3000/mcp --list-tools')
  console.log('')
  console.log('  # Interactive mode (default when no commands given)')
  console.log('  npx tsx packages/client/index.ts --interactive')
}
